...
* **Automated Build & Push**: Builds a Windows-based Docker image from a Dockerfile.
...
graph TD
    ...
    D --> E[Run Katalon Studio Tests]
    E --> F[Process Test Results]
...
| :---- | :---- | :---- |
| REGISTRY_DOMAIN | Artifactory Docker registry domain | mycompany.jfrog.io |
...
2. **Build and Publish Docker Image**: It uses standard docker commands to build a Windows-based image. The jf rt docker-push command then pushes this image to your Artifactory instance and associates it with build information.
